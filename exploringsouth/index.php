    ...
    <P class="collection-heading">Exploring SOUTH For You</P> <br>
        <div class="info_div">
            <div class="information_div">
                <div class="image_container image_container_left image_Keralasouth">
                </div>
            ...
            <div class="flip_div">
                <div class="image_container image_container_right image_Tamil">
                </div>
            ...
            <div class="information_div">
                <div class="image_container image_container_left image_Karnataka">
                </div>
